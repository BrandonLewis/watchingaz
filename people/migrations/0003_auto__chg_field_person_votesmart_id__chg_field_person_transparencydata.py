...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.votesmart_id'
        db.alter_column('people_person', 'votesmart_id', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Person.transparencydata_id'
        db.alter_column('people_person', 'transparencydata_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))


    def backwards(self, orm):
        
        # Changing field 'Person.votesmart_id'
        db.alter_column('people_person', 'votesmart_id', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Person.transparencydata_id'
        db.alter_column('people_person', 'transparencydata_id', self.gf('django.db.models.fields.CharField')(max_length=32))
