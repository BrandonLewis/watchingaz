...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillAction.atype'
        db.add_column('bills_billaction', 'atype', self.gf('watchingaz.lib.models.multifield.MultiSelectField')(default='other', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillAction.atype'
        db.delete_column('bills_billaction', 'atype')
