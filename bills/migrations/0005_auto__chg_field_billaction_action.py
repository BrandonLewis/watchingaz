...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BillAction.action'
        db.alter_column('bills_billaction', 'action', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'BillAction.action'
        db.alter_column('bills_billaction', 'action', self.gf('django.db.models.fields.CharField')(max_length=255))
