...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BillAction.order'
        db.add_column('bills_billaction', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BillAction.order'
        db.delete_column('bills_billaction', 'order')
