...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Answer'
        db.create_table('tools_answer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='answers', to=orm['tools.Question'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_answers', to=orm['dashboard.Profile'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('tools', ['Answer'])

        # Adding field 'Tracker.last_updated'
        db.add_column('tools_tracker', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.today(), blank=True), keep_default=False)

        # Adding field 'Question.user'
        db.add_column('tools_question', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='my_questions', to=orm['dashboard.Profile']), keep_default=False)

        # Adding field 'Question.subject'
        db.add_column('tools_question', 'subject', self.gf('django.db.models.fields.CharField')(default='', max_length=140), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Answer'
        db.delete_table('tools_answer')

        # Deleting field 'Tracker.last_updated'
        db.delete_column('tools_tracker', 'last_updated')

        # Deleting field 'Question.user'
        db.delete_column('tools_question', 'user_id')

        # Deleting field 'Question.subject'
        db.delete_column('tools_question', 'subject')
