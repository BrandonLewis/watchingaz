...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Trackable'
        db.create_table('tools_trackable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], unique=True)),
        ))
        db.send_create_signal('tools', ['Trackable'])

        # Adding model 'MyTracker'
        db.create_table('tools_mytracker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tracked_items', null=True, to=orm['dashboard.Profile'])),
            ('tracker', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users_tracking', to=orm['tools.Tracker'])),
            ('frequency', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('tools', ['MyTracker'])

        # Adding model 'Tracker'
        db.create_table('tools_tracker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('tracked_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Term'])),
        ))
        db.send_create_signal('tools', ['Tracker'])

        # Adding model 'UserVote'
        db.create_table('tools_uservote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bill', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_votes', to=orm['bills.Bill'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users_votes', to=orm['dashboard.Profile'])),
            ('vote', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal('tools', ['UserVote'])

        # Adding model 'Question'
        db.create_table('tools_question', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('tools', ['Question'])


    def backwards(self, orm):
        
        # Deleting model 'Trackable'
        db.delete_table('tools_trackable')

        # Deleting model 'MyTracker'
        db.delete_table('tools_mytracker')

        # Deleting model 'Tracker'
        db.delete_table('tools_tracker')

        # Deleting model 'UserVote'
        db.delete_table('tools_uservote')

        # Deleting model 'Question'
        db.delete_table('tools_question')
